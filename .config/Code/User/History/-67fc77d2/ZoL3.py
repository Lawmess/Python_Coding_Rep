...
if gender.lower() == 'male':
    Blood_Alcohol_Content = (number_of_alcohol_per_drink_consumed * number_of_drinks * 5.14 / weight * Male_r) - (0.015 * hours_since_the_last_drink)
else:
    Blood_Alcohol_Content = (number_of_alcohol_per_drink_consumed * number_of_drinks * 5.14 / weight * Female_r) - (0.015 * hours_since_the_last_drink)
